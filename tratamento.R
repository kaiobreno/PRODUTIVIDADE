...
dados_2020 <- read_excel("Indicadores - Atualizado em 2020-10-12 08-02-43.xls") ####
...
acervo_outubro_20 <- read_excel("Acervo - Atualizado em 2020-10-12 08-00-22.xls") ###
...
taxa <- read_excel("Taxa de congestionamento - Atualizado em  2020-10-12 08-00-21.xls") ###
...
distribuidos <- read_excel("Distribuições - Atualizado em 2020-10-12 08-01-23.xls") ####
