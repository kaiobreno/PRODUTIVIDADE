...
dados_2020 <- read_excel("Indicadores - Atualizado em 2020-09-28 08-01-40.xls") ####
...
taxa <- read_excel("Taxa de congestionamento - Atualizado em  2020-09-28 08-00-22.xls") ###
...
distribuidos <- read_excel("Distribuições - Atualizado em 2020-09-28 08-01-36.xls") ####
