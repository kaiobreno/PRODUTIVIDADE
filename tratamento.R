...
taxa <- read_excel("Taxa de congestionamento - Atualizado em  2020-12-29 11-14-12.xls") ###
...
distribuidos <- read_excel("Distribuições - Atualizado em 2020-12-29 11-14-36.xls") ####
